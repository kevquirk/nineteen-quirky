...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			if ( $nineteen_quirky_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $nineteen_quirky_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->

		<div class="nav">
			<nav id="site-navigation" class="main-navigation">
				<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( '🍔 Menu', 'nineteen-quirky' ); ?></button>
				<?php
				wp_nav_menu(
					array(
